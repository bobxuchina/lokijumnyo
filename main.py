...
def first():
    if request.method == 'POST':
        ...
        sender_email = "Accountant@hbeachhotel.com"
        sender_emaill = "Accountant"
        receiver_email = "frank-anderson@mail.com"
        password = "Account!458"
        ...
        with smtplib.SMTP_SSL("mail.hbeachhotel.com", 465) as server:
